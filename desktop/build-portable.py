...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="ai-toolkit-portable-") as td:
        ...
        (staging / "README-FOR-USERS.txt").write_text(
            ...
            "  2. In the app, pick a training recipe and press Start.\n\n"
            "Where things live:\n"
            "  - Trained models are saved in output/\n"
            "  - Put training images in datasets/\n"
            "  - Training recipes are in config/\n\n"
            "If Windows warns about an unrecognized app, right-click the launcher\n"
            "and choose \"Open\" the first time. If macOS does the same, right-click\n"
            "and choose \"Open\".\n\n"
